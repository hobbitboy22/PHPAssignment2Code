# This test will be to delete a piece of equipment from the database from within the website
...
DeleteButton = driver.find_element(By.XPATH, '/html/body/div[1]/table/tbody[2]/tr[2]/td[7]/form[2]/button')
DeleteButton.click()

print('Equipment has been deleted')
