# This test will be to add a new piece of equipment
...
AddEquipmentButton = driver.find_element(By.XPATH, '/html/body/div[1]/button')
AddEquipmentButton.click()

ItemName = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[1]/input')
ItemName.send_keys('New Carrot')

ItemDescription = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[2]/input')
ItemDescription.send_keys('A new description')

ItemStock = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[3]/input')
ItemStock.send_keys('5')

ItemBuyPrice = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[4]/input')
ItemBuyPrice.send_keys('1')

ItemSellPrice = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[5]/input')
ItemSellPrice.send_keys('1.25')

ConfirmButton = driver.find_element(By.XPATH, '//*[@id="additemmodal"]/div/div/div[2]/form/div[7]/button[1]')
ConfirmButton.click()
